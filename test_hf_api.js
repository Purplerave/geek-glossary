// test_hf_api.js
const fetch = require('node-fetch'); // Necesario si tu Node.js local es < 18
  // o si quieres ser explícito

async function testHuggingFaceAPI() {
  const HF_API_TOKEN = "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"; // ¡REEMPLAZA ESTO CON TU TOKEN REAL!
